...
// µ±Ç°°æ±¾: V1.0
// ÀúÊ·°æ±¾:
//  - V1.0: (2020-11-11)W25QXX³õÊ¼»¯ºÍÅäÖÃ
// µ÷ÊÔ¹¤¾ß: ÁèÖÇSTM32H750ºËÐÄ°å¡¢LZE_ST_LINK2
// Ëµ    Ã÷: 
//    
//-----------------------------------------------------------------
...
{ 
	...
	__HAL_RCC_GPIOA_CLK_ENABLE();           // Ê¹ÄÜGPIOGÊ±ÖÓ
	
	GPIO_Initure.Pin=GPIO_PIN_2;            // PA2 -> FLASH_CS
	GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;  // ÍÆÍìÊä³ö
	GPIO_Initure.Pull=GPIO_PULLUP;          // ÉÏÀ­
	GPIO_Initure.Speed=GPIO_SPEED_FREQ_HIGH;// ¿ìËÙ         
...
void W25QXX_Read(u8* pBuffer,u32 ReadAddr,u16 NumByteToRead)   
{ 
	//W25QXX_Init();  //AD7606ºÍflash¹²ÓÃ¹Ü½Å£¬Ã¿´ÎÊ¹ÓÃÇ°³õÊ¼»¯
 	u16 i;   										    
	W25QXX_CS_L;                            	// Ê¹ÄÜÆ÷¼þ   
	...
	W25QXX_CS_H;  	
	//AD7606_Init(); //AD7606ºÍflash¹²ÓÃ¹Ü½Å£¬Ã¿´ÎÊ¹ÓÃºó³õÊ¼»¯7606
}  
