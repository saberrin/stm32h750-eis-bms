...
//					  HAL_Delay(100);
//        AD7606_ReadData(DB_data1);
//				printf("1: %.4f V\r\n", AD7606B_Digital2Voltage(DB_data1[0]));
//				printf("2: %.4f\r\n", AD7606B_Digital2Voltage(DB_data1[1]));
//				printf("3: %.4f V\r\n", AD7606B_Digital2Voltage(DB_data1[2]));
//				printf("4: %.4f \r\n", AD7606B_Digital2Voltage(DB_data1[3]));
//				printf("5: %.4f V\r\n", AD7606B_Digital2Voltage(DB_data1[4]));
//				printf("6: %.4f V\r\n", AD7606B_Digital2Voltage(DB_data1[5]));
//      printf("\r\n");
//			
//			
